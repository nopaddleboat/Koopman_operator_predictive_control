%2020/03/18
%use Taylor series to linearize the system and apply predictive control
clear,clc,
...
t=(0:Ts:5)';
amp=1.5;
testU=amp*(sin(2*pi*352.6*t+1.5*pi)+1);
...
%MPC parameters setup
    for k2=1:Nh
        if(k2==1)
            ...
            Lpc(k2)=Lpc(k2-1)+Cpc*Apc^(k2-1)*Mc;
        end
...
%tracking results and tracking error
subplot(1,2,1),
